...
This is a **Rush monorepo** for OpenFront-related projects. The primary package is OpenFrontIO, a multiplayer strategy game maintained as a git subtree with a fork-based workflow.
...
- Don't force-push to git subtree directories
...
OpenFrontIO at `external/openfrontio` is a git subtree with fork-based workflow:
...
See `docs/SUBTREE.md` for detailed guide.
